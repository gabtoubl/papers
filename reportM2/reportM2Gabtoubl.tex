...
\begin{document}
  ...
  \chapter{Comptage des k-mers}
    ...
    \section{État de la recherche sur les k-mers}
      Parmi les différents logiciels qui permettent le comptage des k-mers simples, nous avons cité l'outil \textbf{Jellyfish} \cite{Marcais2011} qui est de très loin le plus efficace (500Mo en moins de 15s, avec 8 threads), et qui est spécialisé dans l'approche \textit{multi-threading}.\\
